<?php
/**
 * WC_Shipping_PrintAndShip_Tracked class.
 *
 * @category Class
...
class WC_Shipping_PrintAndShip_Tracked extends \WC_Shipping_Method
{
    ...
    {
        $this->id                 = 'print_and_ship_tracked';
        $this->instance_id        = absint($instance_id);
        $this->method_title       = __('Printeers - Tracked mail');
        $this->method_description = __(
            'This shipment method is connected to shipping level Tracked.
            Shipments using this shipping level will be sent with tracking
            and delivered in the mailbox as regular mail.
